                ...
                <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all '>
                  ...
                  <button
                      className={`flex-1 px-4 py-2 rounded text-sm outline-none ${
                        accountType === "seeker"
                          ? "bg-[#008000] text-white-900 font-semibold"
                    ...
                    <button
                      className={`flex-1 px-4 py-2 rounded text-sm outline-none ${
                        accountType !== "seeker"
                          ? "bg-[#008000] text-white-900 font-semibold"
                          : "bg-green border border-green-400"
                      }`}
                  ...
                  <form
                  className='w-full flex flex-col gap-5' onSubmit={handleSubmit(onsubmit)}>
                    <TextInput
                      name='email'
                      label='Email Address'
                    ...
                    <div className='mt-2'>
                      <CustomButton
                        type='submit'
                        containerStyles={`inline-flex justify-center rounded-md bg-green-600 px-8 py-2 text-sm font-medium text-white outline-none hover:bg-blue-800`}
